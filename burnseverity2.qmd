...
![Figure 1: Total Area Burned per Year Based on Cause in BC](images/burnseverity_fire_causes.png)
...
![Pre-fire RGB Image](images/burnseverity_prefire.png)
![Post-fire RGB Image](images/burnseverity_postfire.png)
...
![Plotted Average NDVI over the Year of the Landsape](images/burnseverity_avg_NDVI.png)
...
![Post-fire Classified Landscape Based on Fire Severity](images/burnseverity_classified.png)
...
![Distribution of NDVI Values by Burn Severity Class](images/burnseverity_NDVI_distribution.png)
